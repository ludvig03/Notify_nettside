 ...
 * ```
 */
export declare const webp: (options: SquooshOptions) => Transform;
/**
 ...
 * ```
 */
export declare const mozjpeg: (options: SquooshOptions) => Transform;
/**
 ...
 * ```
 */
export declare const oxipng: (options: SquooshOptions) => Transform;
